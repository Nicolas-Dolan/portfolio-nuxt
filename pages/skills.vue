      ...
      <div class="row">
        <div class="col-sm">
          ...
          <div class="d-flex flex-wrap justify-content-between">
            ...
            <div class="techBundle">
              <i class="devicon-django-plain skillIcon"></i>
              <p>Django</p>
            </div>
            <div class="techBundle">
              <i class="devicon-postgresql-plain skillIcon"></i>
              <p>PostgreSQL</p>
            </div>
            <div class="techBundle">
            ...
            <div class="techBundle">
              <i class="devicon-css3-plain skillIcon"></i>
              <p>CSS3</p>
            </div>
            <div class="techBundle">
            ...
            <div class="techBundle">
              <i class="devicon-github-plain skillIcon"></i>
              <p>GitHub</p>
            </div>
          </div>
          ...
          <p>
            ...
            & Algorithms | SOLID Principles | Object-Oriented Programming |
            Functional Programming | Serverless Architecture | Requirements
            Gathering
          </p>
        </div>
        <div class="col-sm align-self-start">
          ...
          <p>
            I’ve become increasingly obsessed with AI, consuming every book,
            documentary, and seminar on the topic I can get my hands on. I’m
            very optimistic about the increasing benefit AI will provide to
            society and I would eventually like to get involved in its
            development directly.
          </p>
          <h5>Spanish</h5>
          <p>
            I’ve been learning Spanish for a couple of years now. The process
            has taught me a lot about self-directed learning – an invaluable
            skill when learning to code! I eventually want to travel around
            South America to immerse myself in the language.
          </p>
        </div>
      </div>
    </div>
